...
import { login as loginApi, pingBackend } from "@/lib/api";
    ...
    <div className="flex flex-col h-full bg-white px-6 justify-between pt-[5%] pb-[5%] overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center flex-shrink-0 mt-[10%] mb-[30%]">
          <h1 className="text-[28px] font-black text-[#f66b1e] tracking-tight">{t.login.title}</h1>
          <p className="text-[#575757] text-[15px] mt-2 font-medium">{t.login.greeting}</p>
        </div>
