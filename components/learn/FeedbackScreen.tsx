      ...
      <div className="px-6 flex-1 overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        ...
        >
          ...
          <div className="flex items-center gap-2 pt-2">
            <h2 className="text-[20px] font-bold text-[#222222] flex flex-col gap-2 leading-snug">
              <div className="flex items-center gap-2">
                <CheckCircle2 size={24} className="text-[#22c55e] fill-[#22c55e]/20" />
                <span>{t.learn.verifyComplete}</span>
              </div>
            </h2>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-white border border-[#f8f8f8] rounded-[20px] p-5 shadow-[0_8px_20px_rgba(0,0,0,0.03)]">
              <h3 className="font-extrabold text-[#f66b1e] text-[13px] mb-2">{t.learn.meaningFeedback}</h3>
              <p className="text-[#222222] leading-relaxed text-[14px] font-medium">{feedback.meaningFeedback}</p>
              {feedback.meaningCorrect === false && feedback.meaningSuggestion && (
                <div className="mt-4 p-4 bg-[#f66b1e]/10 rounded-[15px] text-[14px] text-[#222222] border border-[#f66b1e]/20">
                  <span className="font-bold text-[#f66b1e] block mb-1">💡 {t.learn.suggestionTip}</span> 
            ...
            <div className="bg-white border border-[#f8f8f8] rounded-[20px] p-5 shadow-[0_8px_20px_rgba(0,0,0,0.03)]">
              <h3 className="font-extrabold text-[#f66b1e] text-[13px] mb-2">{t.learn.grammarFeedback}</h3>
              <p className="text-[#222222] leading-relaxed text-[14px] font-medium">{feedback.grammarFeedback}</p>
